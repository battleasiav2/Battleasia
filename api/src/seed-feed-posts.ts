...
const FEED_POSTS: FeedPostSeed[] = [
  ...
  },
  {
    ...
    description:
      '<p>Our biggest <strong>Erangel Solo</strong> event of the month is here. Entry fee starts at 20 BAC with per-kill rewards and a champion bonus.</p><p>Room opens 30 minutes before match time. Good luck, warriors!</p>',
  ...
  },
  {
    ...
    categorySlug: 'guides',
    description:
      '<p>New to BattleAsia? Follow these steps:</p><ol><li>Set your <strong>PUBG ID</strong> in profile</li><li>Deposit BAC coins to your wallet</li><li>Go to <strong>Play</strong> and pick an active match</li><li>Tap <strong>Join</strong> and wait for room credentials</li></ol>',
  ...
  },
  {
    ...
    description:
      '<p>We expanded the map pool! Expect more variety in squad and duo rooms with <strong>Miramar</strong> desert fights and fast-paced <strong>Sanhok</strong> action.</p>',
  ...
  },
  {
    ...
    categorySlug: 'guides',
    description:
      '<p><strong>Premium insight:</strong> Position early, conserve smokes, and coordinate flanks. Top players average 6+ kills in TDM Warehouse clashes.</p><p>Upgrade to premium for exclusive strategy posts every week.</p>',
...
async function ensureCategories() {
  const map = new Map<string, InstanceType<typeof FeedCategory>>();
