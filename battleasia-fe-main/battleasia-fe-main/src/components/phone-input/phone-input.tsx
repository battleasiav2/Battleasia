  ...
  return (
    ...
    >
          ...
          sx={[
            {
              ...
              ...((variant === 'filled' || variant === 'outlined') && !countrySelectorSx && {
                mt: size === 'small' ? '8px' : '16px',
              }),
              ...(variant === 'filled' && hasLabel && !countrySelectorSx && { mt: size === 'small' ? '21px' : '25px' }),
            },
            ...(countrySelectorSx ? (Array.isArray(countrySelectorSx) ? countrySelectorSx : [countrySelectorSx]) : []),
          ]}
        />
      )}
      ...
      <PhoneNumberInput
        ...
        slotProps={{
          inputLabel: { shrink: true, ...externalSlotProps?.inputLabel },
          input: {
