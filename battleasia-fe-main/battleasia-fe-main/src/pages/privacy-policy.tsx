...
const metadata = { title: `${CONFIG.appName} | Privacy Policy` };
      ...
      <Box sx={{ backgroundColor: 'background.default', py: { xs: 10, md: 16 } }}>
        <Container maxWidth="md">
          <Stack spacing={3}>
            ...
            <Section title="2) Information we collect">
              <List dense sx={{ pl: 1 }}>
                <ListItem disableGutters>
                  <ListItemText
                    primary="Account & Identity: Username, email, password (hashed), country/region, and optional contact details."
                  />
                </ListItem>
                <ListItem disableGutters>
            ...
            <Section title="4) Legal bases (where applicable, e.g., GDPR)">
              <List dense sx={{ pl: 1 }}>
                <ListItem disableGutters>
            ...
            <Section title="8) Your choices and rights (subject to your jurisdiction)">
              <List dense sx={{ pl: 1 }}>
                <ListItem disableGutters>
