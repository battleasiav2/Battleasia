...
export const authSubmitButtonSx = {
  ...
  `,
  transition:
    'transform 0.15s ease, box-shadow 0.2s ease, background 0.2s ease, border-color 0.2s ease, color 0.2s ease',
  '@media (hover: hover)': {
    '&:hover': {
      filter: 'none',
      color: '#ffe066',
      ...
      borderColor: '#ffe066',
      boxShadow: `
        inset 0 0 24px ${alpha('#f5c518', 0.1)},
        0 0 20px ${alpha('#f5c518', 0.18)},
  ...
  '&:active, &.Mui-focusVisible': {
    ...
    boxShadow: `inset 0 2px 4px ${alpha('#000000', 0.25)}`,
