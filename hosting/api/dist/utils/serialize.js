...
export function serializeUser(user, roleDoc) {
    const roleRef = roleDoc || user.roleRef;
...
export function serializeRole(role, parent) {
    return {
...
export function serializeMatch(match, gameName) {
    return {
